...
import (
	...
	"github.com/rakasiwisurya/learn-go-chi-microservice/model"
	"github.com/rakasiwisurya/learn-go-chi-microservice/repository/order"
)
...
func (o *Order) Create(w http.ResponseWriter, r *http.Request) {
	var body struct {
		...
		LineItems  []model.LineItem `json:"line_times"`
	}
